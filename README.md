...
- **日程の一覧確認**: `/admin/schedule/list` で、全アクティビティの登録済み日程(日付・時刻・定員・予約状況)を1つの一覧表で確認できます
...
- **ONにすると**、担当ガイドが1人も登録されていない便はお客様が予約できなくなります。時間枠には「運行なし」と表示され、その日の便に1つもガイドが登録されていない日はカレンダー上でオレンジの点で示されます(緑の点=ガイド付きツアー予約可能な日)。
